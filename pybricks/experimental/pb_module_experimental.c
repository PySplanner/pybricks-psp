...
// MicroPython usually defines STATIC in mpconfig.h
#ifndef STATIC
#define STATIC static
#endif

// 1. The benchmark function logic
...
// The name must match pb_module_<filename>_globals for the auto-generator.
